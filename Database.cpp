...
Database::Database() : driver(get_driver_instance()) {
	...
	try {
		...
		try {
			...
			stmt->execute("INSERT INTO book_attributes (book_id, title, author, translator, publisher, publishing_year, pages_number, book_weight, condition_id, translate_number) "
				"VALUES "
				...
				"(7, 'The Little Prince', 'Antoine de Saint Exupery', 'Katherine Woods', 'Reynal and Hitchcock', '1945', 128, 1, 6, 3), "
				...
				"(12, 'The lover', 'Nimrod Zahavi', 'Shay Barlev', 'Carmel Publishing House', '2012', 209, 2, 4, 1), "
				"(13, 'The Glass Hotel', 'Emily St. John Mandel', 'Eliyahu Shabat', 'HarperCollins', '2020', 320, 2, 1, 1);");
			...
			stmt->execute("INSERT INTO transactions (trans_id, book_id, cust_id, trans_date, meth_id, books_num, emp_id) "
				...
				"(2, 10, 2, '2018-01-12', 1, 1, 1), "
				"(3, 2, 6, '2018-03-15', 1, 2, 1), "
				"(4, 3, 7, '2018-03-15', 1, 2, 1), "
				"(5, 2, 1, '2018-05-25', 3, 4, 1), "
				"(6, 11, 9,  '2018-05-27', 3, 0, 1), "
				"(7, 7, 3,  '2018-07-04', 1, 1, 1), "
				"(8, 11, 5,  '2018-07-12', 3, 5, 1), "
				"(9, 10, 8,  '2018-09-22', 1, 3, 1), "
				"(10, 4, 9,  '2018-09-30', 3, 4, 1), "
				"(11, 2, 10,  '2019-02-07', 3, 1, 2), "
				"(12, 10, 6,  '2019-02-17', 3, 7, 2), "
				"(13, 6, 7, '2019-04-19', 3, 6, 3), "
				"(14, 5, 7,  '2019-06-24', 1, 0, 3), "
				"(15, 10, 7,  '2019-06-11', 1, 8, 3), "
				"(16, 2, 2, '2019-08-18', 1, 2, 4), "
				"(17, 9, 3, '2019-10-24', 1, 4, 5), "
				"(18, 8, 4, '2019-10-02', 1, 5, 5), "
				"(19, 10, 9, '2019-12-23', 3, 5, 5), "
				"(20, 4, 10, '2019-12-04', 1, 7, 5), "
				"(21, 2, 5, '2020-01-14', 3, 2, 6), "
				"(22, 6, 2, '2020-02-21', 3, 0, 6), "
				"(23, 2, 3, '2020-03-28', 3, 5, 6), "
				"(24, 3, 4, '2020-04-01', 3, 9, 6), "
				"(25, 2, 1, '2020-05-04', 2, 1, 8), "
				"(26, 11, 2, '2020-05-10', 2, 8, 9), "
				"(27, 4, 3, '2020-05-15', 2, 9, 8), "
				"(28, 1, 4, '2020-05-19', 2, 1, 9), "
				"(29, 10, 6, '2020-05-23', 2, 1, 9), "
				"(30, 10, 6, '2020-05-25', 2, 1, 9), "
				"(31, 12, 4, '2020-05-27', 2, 1, 8);");
			stmt->execute("INSERT INTO orders (order_id, book_id, cust_id, order_date, meth_id, ship_id, status_id, books_num, dest_id1, dest_id2) "
				"VALUES "
				"(1, 1, 3, '2018-05-04', 3, 5, 4, 1, 2, NULL), "
				"(2, 4, 3, '2018-05-13', 1, 5, 4, 2, 2, NULL), "
